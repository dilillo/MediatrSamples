...
using WebData = SuperFake.Web.Data;
...
namespace SuperFake.Web.Controllers
{
    public class OrderItemsController : BaseController
    {
        ...
        public async Task<IActionResult> Create(int orderID)
        {
            ...
            var model = new WebData.OrderItem { OrderID = orderID, Quantity = 1 };
        ...
        public async Task<IActionResult> Create([Bind("OrderID,ProductID,Quantity")] OrdersData.OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,OrderID,ProductID,Quantity")] OrdersData.OrderItem orderItem)
        {
            if (id != orderItem.ID)
            {
                return NotFound();
